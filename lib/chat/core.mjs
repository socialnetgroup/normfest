...
export const TOOLS = [
  ...
  },
  {
    name: "search_kb",
    description:
      "Durchsucht Skript (Gesprächsleitfaden, 5-Phasen-Struktur, Formulierungen) und Wissen (Hintergrundwissen) per Volltextsuche (Wortsuche ohne Stemming — Suchbegriffe müssen in der Wortform vorkommen, die im Text steht). Beide Sammlungen ('skript' und 'wissen') sind auf Deutsch. Wenn eine Suche nichts findet, versuche höchstens 1-2 andere Suchbegriffe — nicht endlos wiederholen.",
    input_schema: {
      type: "object",
      properties: {
        query: { type: "string" },
